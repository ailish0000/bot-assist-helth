...
5. Вместо фразы "По имеющимся данным в предоставленном контексте" пиши просто "По имеющимся у меня данным" 

ПРАВИЛА ОТВЕТА:
1. МАКСИМАЛЬНО используй всю доступную информацию из контекста
2. При неполной информации: "По имеющимся данным..." + то что знаешь
...
6. ПРИОРИТЕТ: Дать максимально полезный ответ на основе имеющихся материалов"""
                },
                {
                    "role": "user",
                    "content": prompt,
...
def get_answer(question: str) -> str:
    ...
    try:
        ...
        if "Qdrant connection failed" in str(e):
            return "В предоставленных материалах нет информации по этому вопросу."
        elif "Vector search failed" in str(e):
            return "В предоставленных материалах нет информации по этому вопросу."
